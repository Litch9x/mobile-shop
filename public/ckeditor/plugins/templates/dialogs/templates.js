...
(function () {
  CKEDITOR.dialog.add("templates", function (c) {
    function r(a, b) {
      var n = CKEDITOR.dom.element.createFromHtml(
    ...
    return {
              ...
              children: [
                {
                  ...
                  default: p.templates_replaceContent,
                },
                {
                  id: "selectTplText",
                  type: "html",
      ...
      onShow: function () {
        ...
        g = a.getElement();
        CKEDITOR.loadTemplates(p.templates_files, function () {
          var b = (p.templates || "default").split(",");
          if (b.length) {
            var c = g;
            c.setHtml("");
            for (var d = 0, h = b.length; d < h; d++)
              for (
                ...
                var q = r(e[m], l);
                q.setAttribute("aria-posinset", m + 1);
                q.setAttribute("aria-setsize", k);
                c.append(q);
              }
            a.focus();
          } else
